...
class RKLLMParam:
    ...
    n_keep: (
        int  # Number of KV cache to keep at the beginning when shifting context window
    )
    top_p: float  # Top-P (nucleus) sampling parameter
    temperature: (
        float  # Sampling temperature, affecting the randomness of token selection
    )
...
class RKLLMWrapperBase:
    ...
    def setPromptTemplate(
        self, systemPrompt: str, userPromptPrefix: str, userPromptSuffix: str
    ) -> bool:
